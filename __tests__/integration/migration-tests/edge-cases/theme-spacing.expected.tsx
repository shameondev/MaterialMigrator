...
export const ThemeSpacingComponent: React.FC = () => {
  ...
  return <div>
      ...
      <div className={cn(classes.mixedSpacing, "p-6 m-4 flex flex-col var(--palette-background-paper)")}>Mixed Spacing</div>
      <div className="pt-4 pr-8 pb-10 pl-2 mt-10 mr-16 mb-14 ml-20">Spacing Variations</div>
    </div>;
};
